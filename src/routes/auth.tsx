  ...
  return (
    <div className="min-h-screen bg-secondary text-secondary-foreground">
      <div className="mx-auto flex min-h-screen max-w-md flex-col px-5 pb-10 pt-6">
        <Link to="/" className="inline-flex w-fit items-center gap-2 text-sm text-secondary-foreground/70 hover:text-secondary-foreground">
        ...
        <div className="mt-8 flex items-center gap-3">
          ...
          <div>
            ...
            <h1 className="text-2xl font-extrabold">{tab === "signin" ? "Entrar" : "Criar conta"}</h1>
          </div>
        </div>
        ...
        <div className="mt-8 rounded-3xl bg-background p-6 text-foreground shadow-[var(--shadow-card)]">
            ...
            <div className="mt-5">
              ...
              <div className="grid grid-cols-2 gap-2">
                {(["passenger", "driver"] as const).map((r) => (
                  ...
                  >
                    <p className="text-sm font-bold">{r === "passenger" ? "Passageiro" : "Motorista"}</p>
          ...
          <form onSubmit={handleSubmit} className="mt-5 space-y-3">
            ...
            <Button type="submit" className="h-11 w-full text-sm font-bold" disabled={loading}>
              {loading ? <Loader2 className="size-4 animate-spin" /> : tab === "signin" ? "Entrar" : "Criar conta"}
            </Button>
          </form>
          ...
          <Button variant="outline" className="h-11 w-full text-sm font-semibold" onClick={handleGoogle} disabled={loading}>
...
function GoogleIcon() {
  return (
    <svg viewBox="0 0 24 24" className="size-4">
      ...
      <path fill="#FBBC05" d="M5.87 14.11A6.97 6.97 0 015.5 12c0-.73.13-1.44.37-2.11V7.05H2.18A11 11 0 001 12c0 1.78.43 3.46 1.18 4.95l3.69-2.84z" />
