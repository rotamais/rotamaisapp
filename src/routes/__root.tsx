  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Ocorreu um problema ao inicializar a aplicação. Tente recarregar a página ou voltar para a home.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Rotamais" },
      { name: "description", content: "Aplicativo de Mobilidade" },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Rotamais" },
      { property: "og:description", content: "Aplicativo de Mobilidade" },
