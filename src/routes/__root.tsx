    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a
            href="/"
            className="inline-flex items-center justify-center rounded-lg border border-input bg-background px-4 py-2 text-sm font-semibold hover:bg-accent"
          >
            Início
          </a>
        </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "RotaMais — Mobilidade urbana" },
      { name: "description", content: "Peça corridas urbanas em tempo real com o RotaMais. Conectando passageiros e motoristas com agilidade e segurança." },
      { property: "og:title", content: "RotaMais — Mobilidade urbana" },
      { property: "og:description", content: "Peça corridas urbanas em tempo real com o RotaMais." },
